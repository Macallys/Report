...
STORIES_PART3 = [
    ...
    S("HU24", "EP04", "Cruce de presencia de personal con niveles de CO₂",
    ...
    # E5
    S("HU25", "EP05", "Detección de exceso de CO₂",
    ...
    S("HU26", "EP05", "Detección de ruido excesivo",
    ...
    S("HU27", "EP05", "Activación automática del extractor de aire por CO₂",
    ...
    S("HU28", "EP05", "Activación de sirena preventiva por exposición a condición peligrosa",
    ...
    S("HU29", "EP05", "Despliegue de mamparas acústicas por exposición sonora",
    ...
    S("HU30", "EP05", "Anulación manual de actuador en emergencia",
    ...
    S("HU31", "EP05", "Registro de acciones automáticas ejecutadas",
    ...
    S("HU32", "EP05", "Notificación física de alarma al operario expuesto",
