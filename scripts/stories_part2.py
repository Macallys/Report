...
STORIES_PART2 = [
    # E2 HU07-13
    S("HU07", "E2", "Inicio de sesión de supervisor de seguridad",
    ...
    S("HU08", "E2", "Inicio de sesión de administrador de planta",
    ...
    S("HU09", "E2", "Inicio de sesión de operario de planta",
    ...
    S("HU10", "E2", "Cierre de sesión de usuario autenticado",
    ...
    S("HU11", "E2", "Creación de cuenta de usuario por administrador",
    ...
    S("HU12", "E2", "Asignación de roles y permisos de usuario",
    ...
    S("HU13", "E2", "Recuperación de credenciales de acceso",
    ...
    # E3 HU14-23
    S("HU14", "E3", "Dashboard consolidado de la planta",
    ...
    S("HU15", "E3", "Monitoreo de CO₂ en tiempo real por zona",
    ...
    S("HU16", "E3", "Monitoreo de ruido en tiempo real por zona",
    ...
    S("HU17", "E3", "Monitoreo de presencia de personal por zona",
    ...
    S("HU18", "E3", "Visualización de alertas activas",
    ...
    S("HU19", "E3", "Mapa digitalizado de riesgos por zona",
    ...
    S("HU20", "E3", "Gestión de zonas críticas",
    ...
    S("HU21", "E3", "Configuración de umbrales ambientales por zona",
    ...
    S("HU22", "E3", "Registro de dispositivos IoT por zona",
    ...
    S("HU23", "E3", "Consulta de historial de mediciones y eventos ambientales",
