...
STORIES = [
    # E1
    S("HU01", "E1", "Consulta de información del sistema SafePlant",
    ...
    S("HU02", "E1", "Consulta de beneficios y ventajas de SafePlant",
    ...
    S("HU03", "E1", "Consulta del equipo desarrollador",
    ...
    S("HU04", "E1", "Envío de formulario de contacto",
    ...
    S("HU05", "E1", "Consulta de arquitectura técnica del sistema",
    ...
    S("HU06", "E1", "Navegación hacia la plataforma de supervisión",
