...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td align="left">Como visitante quiero conocer el producto SafePlant, sus beneficios y al equipo responsable para evaluar la solución de control de seguridad y contaminación industrial, e identificar el acceso a la aplicación móvil de operación y configuración técnica y a la aplicación web de gobernanza y métricas.</td>
    </tr>
    <tr>
      <td align="left">EP02</td>
      <td align="left">Registro y Autenticación</td>
      <td align="left">Como usuario autorizado quiero autenticarme en el canal correspondiente a mi rol —aplicación móvil para el supervisor de seguridad (operación y configuración técnica IoT) y aplicación web para el encargado de planta (gobernanza de usuarios y métricas)— para utilizar de forma controlada las funciones autorizadas de cada segmento.</td>
    </tr>
    <tr>
      <td align="left">EP03</td>
      <td align="left">Telemetría y Monitoreo en Tiempo Real</td>
      <td align="left">Como supervisor de seguridad quiero monitorear en tiempo real CO₂, ruido y presencia por áreas industriales desde la aplicación móvil, registrar áreas y umbrales, asociar sensores/actuadores y aplicar configuración o actualizaciones del sistema de seguridad; y como encargado de planta quiero administrar usuarios y roles, y consultar dashboard de métricas e historial completo desde la aplicación web para gobernar la operación de la planta.</td>
    </tr>
    <tr>
      <td align="left">EP04</td>
      <td align="left">Evaluación de Exposición por Presencia</td>
      <td align="left">Como supervisor de seguridad quiero que el sistema cruce la presencia detectada por sensores con las condiciones ambientales de CO₂ y ruido para identificar exposición de personal en áreas industriales y priorizar alertas desde la aplicación móvil.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="left">Como encargado de planta quiero crear cuentas de usuario para supervisores de seguridad y encargados de planta en la aplicación web para habilitar el acceso controlado a la operación móvil y a la gobernanza web.</td>
    ...
    <tr>
      ...
      <td align="left">Dashboard operativo consolidado de áreas de la planta</td>
      <td align="left">Como supervisor de seguridad quiero visualizar el estado operativo consolidado de todas las áreas industriales registradas en la aplicación móvil para obtener una visión general del estado ambiental y de seguridad en tiempo real de forma remota.</td>
      <td align="left"><strong>Escenario 1: Vista general de áreas industriales</strong><br/>Dado que el supervisor de seguridad accede a la aplicación móvil autenticado,<br/>Cuando el sistema carga el estado de las áreas industriales registradas,<br/>Entonces la aplicación móvil presenta el resumen de CO₂ en ppm, ruido en dB, presencia y estado de alerta de cada área.<br/><br/><strong>Escenario 2: Identificación de áreas en condición de riesgo</strong><br/>Dado que una o más áreas presentan condiciones fuera de los límites permitidos,<br/>Cuando el supervisor consulta el dashboard operativo en la aplicación móvil,<br/>Entonces el sistema identifica las áreas que requieren atención inmediata.<br/><br/><strong>Escenario 3: Planta sin áreas registradas</strong><br/>Dado que el sistema no posee áreas industriales registradas,<br/>Cuando el supervisor consulta el dashboard operativo en la aplicación móvil,<br/>Entonces el sistema informa que no existen áreas configuradas para monitoreo.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
      <td align="left">HU15</td>
      <td align="left">Monitoreo de CO₂ en tiempo real por área</td>
      <td align="left">Como supervisor de seguridad quiero monitorear en tiempo real la concentración de CO₂ en ppm de un área industrial desde la aplicación móvil para identificar oportunamente acumulaciones peligrosas del gas en el ambiente industrial.</td>
      <td align="left"><strong>Escenario 1: Consulta de concentración de CO₂ actual</strong><br/>Dado que el supervisor consulta un área industrial con sensor de CO₂ activo desde la aplicación móvil,<br/>Cuando el sensor MQ-135 registra una concentración de CO₂ en ppm,<br/>Entonces el sistema registra y presenta el valor actual de CO₂ del área en la aplicación móvil.<br/><br/><strong>Escenario 2: Actualización de medición de CO₂</strong><br/>Dado que el supervisor monitorea un área industrial en la aplicación móvil<br/>Y el sensor de CO₂ genera una nueva medición,<br/>Cuando el sistema recibe la nueva medición a través del IoT Gateway,<br/>Entonces el sistema actualiza el valor de CO₂ correspondiente a el área monitoreada en la aplicación móvil.<br/><br/><strong>Escenario 3: Sensor de CO₂ sin transmisión de datos</strong><br/>Dado que el supervisor monitorea un área industrial en la aplicación móvil,<br/>Cuando el sensor de CO₂ deja de enviar mediciones dentro del intervalo esperado,<br/>Entonces el sistema identifica el sensor como no disponible y conserva la última medición válida registrada.<br/><br/><strong>Escenario 4: Medición de CO₂ fuera del rango válido del sensor</strong><br/>Dado que el sistema recibe una medición de CO₂ desde el dispositivo embebido,<br/>Cuando el valor de la medición se encuentra fuera del rango operativo del sensor MQ-135,<br/>Entonces el sistema descarta la medición y registra el evento como medición inválida de CO₂.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
      <td align="left">HU16</td>
      <td align="left">Monitoreo de ruido en tiempo real por área</td>
      <td align="left">Como supervisor de seguridad quiero monitorear en tiempo real el nivel de ruido en dB de un área industrial desde la aplicación móvil para identificar oportunamente condiciones de exposición sonora peligrosa para los operarios.</td>
      <td align="left"><strong>Escenario 1: Consulta de nivel de ruido actual</strong><br/>Dado que el supervisor consulta un área industrial con sensor de ruido activo desde la aplicación móvil,<br/>Cuando el decibelímetro registra un nivel sonoro en dB,<br/>Entonces el sistema registra y presenta el valor actual de ruido del área en la aplicación móvil.<br/><br/><strong>Escenario 2: Actualización de medición de ruido</strong><br/>Dado que el supervisor monitorea un área industrial en la aplicación móvil<br/>Y el sensor de ruido genera una nueva medición,<br/>Cuando el sistema recibe la nueva medición a través del IoT Gateway,<br/>Entonces el sistema actualiza el valor de ruido correspondiente a el área monitoreada en la aplicación móvil.<br/><br/><strong>Escenario 3: Sensor de ruido sin transmisión de datos</strong><br/>Dado que el supervisor monitorea un área industrial en la aplicación móvil,<br/>Cuando el decibelímetro deja de enviar mediciones dentro del intervalo esperado,<br/>Entonces el sistema identifica el sensor como no disponible y conserva la última medición válida registrada.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
      <td align="left">HU17</td>
      <td align="left">Monitoreo de presencia de personal por área</td>
      <td align="left">Como supervisor de seguridad quiero monitorear la presencia de personal en un área industrial desde la aplicación móvil para determinar si existen operarios expuestos a condiciones ambientales de riesgo.</td>
      <td align="left"><strong>Escenario 1: Detección de presencia por sensor PIR</strong><br/>Dado que el supervisor monitorea un área industrial con sensor PIR activo desde la aplicación móvil,<br/>Cuando el sensor PIR detecta movimiento en el área,<br/>Entonces el sistema registra la presencia de personal en el área y la presenta en la aplicación móvil.<br/><br/><strong>Escenario 2: Ausencia de personal en área monitoreada</strong><br/>Dado que el supervisor monitorea un área industrial en la aplicación móvil,<br/>Cuando el sensor PIR no detecta actividad en el intervalo configurado,<br/>Entonces el sistema registral área como sin personal presente.<br/><br/><strong>Escenario 3: Sensor PIR sin transmisión de datos</strong><br/>Dado que el supervisor monitorea un área industrial en la aplicación móvil,<br/>Cuando el sensor PIR deja de enviar señales dentro del intervalo esperado,<br/>Entonces el sistema identifica el sensor como no disponible y conserva el último estado de presencia registrado.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
      ...
      <td align="left"><strong>Escenario 1: Listado de alertas activas en la planta</strong><br/>Dado que el sistema ha detectado una o más condiciones de riesgo sin resolver,<br/>Cuando el supervisor consulta las alertas activas en la aplicación móvil,<br/>Entonces el sistema presental área, el tipo de alerta, la medición asociada y la fecha de detección de cada alerta activa.<br/><br/><strong>Escenario 2: Retiro de alerta por normalización de condición</strong><br/>Dado que el supervisor visualiza las alertas activas en la aplicación móvil,<br/>Cuando una condición de riesgo finaliza en un área monitoreada,<br/>Entonces el sistema retira la alerta correspondiente del listado de alertas activas.<br/><br/><strong>Escenario 3: Ausencia de alertas activas en la planta</strong><br/>Dado que no existen condiciones de riesgo activas en ningun área,<br/>Cuando el supervisor consulta las alertas activas en la aplicación móvil,<br/>Entonces el sistema informa que no existen alertas activas en ese momento.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
      <td align="left">HU19</td>
      <td align="left">Visualización del estado ambiental por áreas industriales</td>
      <td align="left">Como supervisor de seguridad quiero visualizar en la aplicación móvil el estado ambiental de cada área industrial registrada para identificar qué áreas requieren atención inmediata.</td>
      <td align="left"><strong>Escenario 1: Listado de áreas en estado seguro</strong><br/>Dado que todas las áreas industriales registradas se encuentran dentro de los límites permitidos,<br/>Cuando el supervisor consulta el listado de áreas en la aplicación móvil,<br/>Entonces el sistema presenta cada área con su nombre, ubicación descriptiva, estado ambiental seguro y mediciones recientes de CO₂, ruido y presencia.<br/><br/><strong>Escenario 2: Identificación de áreas en condición de riesgo</strong><br/>Dado que una o más áreas industriales presentan condiciones fuera de los límites permitidos,<br/>Cuando el supervisor consulta el listado de áreas en la aplicación móvil,<br/>Entonces el sistema prioriza e identifica las áreas con condición de riesgo activa para atención operativa.<br/><br/><strong>Escenario 3: Planta sin áreas registradas</strong><br/>Dado que el sistema no posee áreas industriales registradas,<br/>Cuando el supervisor consulta el listado de áreas,<br/>Entonces el sistema informa que no existen áreas configuradas para monitoreo.<br/><br/><strong>Escenario 4: Consulta del detalle de un área con máquinas asociadas</strong><br/>Dado que existe un área registrada con descripción de ubicación y referencia a máquinas o puestos de trabajo,<br/>Cuando el supervisor selecciona el detalle de esa área,<br/>Entonces el sistema presenta la información del área, sus umbrales, dispositivos asociados y el estado ambiental vigente.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
      <td align="left">HU20</td>
      <td align="left">Registro y administración de áreas industriales</td>
      <td align="left">Como supervisor de seguridad quiero registrar y administrar áreas industriales de la planta desde la aplicación móvil para organizar el monitoreo y asociar dispositivos y umbrales a cada área.</td>
      <td align="left"><strong>Escenario 1: Registro de un área industrial</strong><br/>Dado que el supervisor de seguridad accede a la administración de áreas en la aplicación móvil,<br/>Cuando el supervisor registra una nueva área con nombre, descripción de ubicación en la planta y referencia a máquinas o puestos asociados,<br/>Entonces el sistema almacena el área y la habilita para la asignación de dispositivos y umbrales.<br/><br/><strong>Escenario 2: Modificación de un área existente</strong><br/>Dado que existe un área industrial registrada en el sistema,<br/>Cuando el supervisor modifica el nombre, la ubicación descriptiva o la referencia de máquinas del área,<br/>Entonces el sistema actualiza la información del área conservando su historial de eventos asociado.<br/><br/><strong>Escenario 3: Registro de área con nombre duplicado</strong><br/>Dado que el supervisor intenta registrar un área industrial,<br/>Cuando el nombre del área ya existe en el sistema,<br/>Entonces el sistema rechaza el registro e informa que el área ya se encuentra registrada.<br/><br/><strong>Escenario 4: Registro con datos obligatorios incompletos</strong><br/>Dado que el supervisor inicia el registro de un área,<br/>Cuando omite el nombre o la descripción de ubicación,<br/>Entonces el sistema rechaza el registro e informa los campos obligatorios pendientes.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
      <td align="left">HU21</td>
      <td align="left">Configuración de umbrales ambientales por área</td>
      <td align="left">Como supervisor de seguridad quiero configurar los límites permitidos de CO₂ en ppm y ruido en dB para cada área industrial registrada desde la aplicación móvil para determinar cuándo una condición ambiental representa un riesgo en ese sector de la planta.</td>
      <td align="left"><strong>Escenario 1: Configuración de límites ambientales por área</strong><br/>Dado que el supervisor dispone de un área industrial registrada,<br/>Cuando el supervisor configura los límites permitidos de CO₂ en ppm y ruido en dB para esa área,<br/>Entonces el sistema almacena los límites asociados al área.<br/><br/><strong>Escenario 2: Modificación de límite ambiental existente</strong><br/>Dado que un área industrial tiene límites ambientales configurados,<br/>Cuando el supervisor modifica uno de los límites,<br/>Entonces el sistema reemplaza el valor anterior por el nuevo límite configurado.<br/><br/><strong>Escenario 3: Límite ambiental fuera del rango permitido por el sistema</strong><br/>Dado que el supervisor configura un límite ambiental,<br/>Cuando el valor ingresado no cumple las restricciones establecidas por el sistema,<br/>Entonces el sistema rechaza la configuración e informa que el valor no es válido.<br/><br/><strong>Escenario 4: Área sin umbrales configurados</strong><br/>Dado que existe un área registrada sin umbrales,<br/>Cuando el sistema evalúa mediciones de esa área,<br/>Entonces el sistema informa que no puede clasificar riesgo por umbrales ausentes hasta que el supervisor los configure.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
      <td align="left">HU22</td>
      <td align="left">Registro de dispositivos IoT por área</td>
      <td align="left">Como supervisor de seguridad quiero registrar sensores y actuadores en un área industrial desde la aplicación móvil para habilitar el monitoreo ambiental y las respuestas automáticas en ese sector de la planta.</td>
      <td align="left"><strong>Escenario 1: Registro de sensor en un área industrial</strong><br/>Dado que existe un área industrial registrada en el sistema<br/>Y el supervisor de seguridad accede a la administración de dispositivos en la aplicación móvil,<br/>Cuando el supervisor asocia un sensor con su tipo, identificador y dirección del dispositivo embebido al área,<br/>Entonces el sistema registra el sensor y lo habilita para recibir mediciones.<br/><br/><strong>Escenario 2: Registro de actuador en un área industrial</strong><br/>Dado que existe un área industrial registrada en el sistema<br/>Y el supervisor de seguridad accede a la administración de dispositivos en la aplicación móvil,<br/>Cuando el supervisor asocia un actuador con su tipo, identificador y dirección del dispositivo embebido al área,<br/>Entonces el sistema registra el actuador y lo habilita para recibir órdenes de control.<br/><br/><strong>Escenario 3: Registro de dispositivo con identificador duplicado</strong><br/>Dado que el supervisor de seguridad intenta registrar un dispositivo IoT en la aplicación móvil,<br/>Cuando el identificador del dispositivo ya se encuentra asociado en el sistema,<br/>Entonces el sistema rechaza el registro e informa que el dispositivo ya está en uso.<br/><br/><strong>Escenario 4: Intento de registro desde la aplicación web del encargado</strong><br/>Dado que un encargado de planta autenticado en la aplicación web intenta registrar un dispositivo IoT,<br/>Cuando solicita la creación del dispositivo,<br/>Entonces el sistema deniega la operación e informa que el alta técnica de dispositivos corresponde al supervisor en la aplicación móvil.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
      <td align="left">HU23</td>
      <td align="left">Dashboard de métricas e historial completo de planta</td>
      <td align="left">Como encargado de planta quiero consultar en la aplicación web el dashboard de métricas y el historial completo de mediciones, alertas y eventos de la planta para gobernar la operación con información consolidada.</td>
      <td align="left"><strong>Escenario 1: Consulta del dashboard de métricas</strong><br/>Dado que el encargado de planta mantiene una sesión activa en la aplicación web<br/>Y existen mediciones y eventos registrados,<br/>Cuando el encargado abre el dashboard de métricas,<br/>Entonces el sistema presenta indicadores consolidados de CO₂, ruido, alertas y estado general por área.<br/><br/><strong>Escenario 2: Consulta de historial completo por área y periodo</strong><br/>Dado que existen eventos registrados en una o más áreas,<br/>Cuando el encargado consulta el historial completo para un periodo determinado en la aplicación web,<br/>Entonces el sistema proporciona mediciones, alertas y acciones correspondientes al periodo consultado.<br/><br/><strong>Escenario 3: Historial sin registros en el periodo consultado</strong><br/>Dado que no existen eventos en el periodo consultado,<br/>Cuando el encargado consulta el historial en la aplicación web,<br/>Entonces el sistema informa que no existen eventos registrados para el periodo indicado.<br/><br/><strong>Escenario 4: Restricción de override desde el dashboard web</strong><br/>Dado que el encargado visualiza una alerta activa en el dashboard,<br/>Cuando intenta anular un actuador desde la aplicación web,<br/>Entonces el sistema deniega la operación e informa que el control operativo se realiza en la aplicación móvil.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
      <td align="left">HU24</td>
      <td align="left">Cruce de presencia de personal con niveles de CO₂</td>
      <td align="left">Como supervisor de seguridad quiero que el sistema evalúe simultáneamente la presencia de personal y los niveles de CO₂ en un área industrial y me presente la alerta resultante en la aplicación móvil para determinar si existen operarios expuestos a concentraciones peligrosas del gas.</td>
      <td align="left"><strong>Escenario 1: Exposición de personal a CO₂ excesivo</strong><br/>Dado que el sistema detecta personal presente en un área industrial<br/>Y la concentración de CO₂ en el área supera el límite permitido,<br/>Cuando el sistema evalúa las condiciones del área,<br/>Entonces el sistema identifica una condición de exposición a CO₂, genera una alerta de seguridad paral área y la presenta en la aplicación móvil del supervisor.<br/><br/><strong>Escenario 2: CO₂ excesivo sin personal presente</strong><br/>Dado que el sistema detecta ausencia de personal en un área industrial<br/>Y la concentración de CO₂ en el área supera el límite permitido,<br/>Cuando el sistema evalúa las condiciones del área,<br/>Entonces el sistema identifica una condición de CO₂ excesivo sin exposición de personal y activa el extractor de aire sin activar la sirena preventiva.<br/><br/><strong>Escenario 3: Personal presente con CO₂ dentro del límite</strong><br/>Dado que el sistema detecta personal presente en un área industrial<br/>Y la concentración de CO₂ se encuentra dentro del límite permitido,<br/>Cuando el sistema evalúa las condiciones del área,<br/>Entonces el sistema mantiene el área en estado de exposición segura para el personal presente.</td>
      <td align="left">EP04</td>
    </tr>
    <tr>
      <td align="left">HU25</td>
      <td align="left">Clasificación de severidad de exposición por área</td>
      <td align="left">Como supervisor de seguridad quiero visualizar en la aplicación móvil la severidad de exposición de cada área industrial según presencia y excedencia ambiental para priorizar la atención operativa remota.</td>
      <td align="left"><strong>Escenario 1: Severidad alta por presencia con CO₂ excedido</strong><br/>Dado que un área presenta presenceDetected igual a true y co2Ppm por encima del umbral,<br/>Cuando el supervisor consulta el estado de exposición en la aplicación móvil,<br/>Entonces el sistema presenta severity igual a high, areaId, alertType igual a co2_exposure y la medición asociada.<br/><br/><strong>Escenario 2: Severidad media por ruido excedido sin presencia</strong><br/>Dado que un área presenta noiseDb por encima del umbral y presenceDetected igual a false,<br/>Cuando el supervisor consulta el estado de exposición,<br/>Entonces el sistema presenta severity igual a medium y alertType igual a noise_excess_no_presence.<br/><br/><strong>Escenario 3: Severidad nula en condiciones seguras</strong><br/>Dado que CO₂ y ruido se encuentran dentro de umbral con o sin presencia,<br/>Cuando el supervisor consulta el área,<br/>Entonces el sistema presenta severity igual a none y estado ambiental seguro.<br/><br/><strong>Escenario 4: Área sin umbrales configurados</strong><br/>Dado que el área no posee umbrales vigentes,<br/>Cuando el supervisor consulta la severidad,<br/>Entonces el sistema informa que la severidad no puede calcularse por umbrales ausentes.</td>
      <td align="left">EP04</td>
    </tr>
    <tr>
      <td align="left">HU26</td>
      <td align="left">Historial corto de exposiciones de personal por área</td>
      <td align="left">Como supervisor de seguridad quiero consultar en la aplicación móvil el historial corto de exposiciones recientes por área para atender incidentes activos y verificar la efectividad inmediata de las respuestas automáticas.</td>
      <td align="left"><strong>Escenario 1: Consulta de historial corto con exposiciones recientes</strong><br/>Dado que existen eventos de exposición recientes para un área,<br/>Cuando el supervisor consulta el historial corto en la aplicación móvil,<br/>Entonces el sistema presenta areaId, alertType, severity, measuredValue, detectedAt y resolvedAt cuando aplica, priorizando los eventos más recientes.<br/><br/><strong>Escenario 2: Filtrado por tipo de exposición</strong><br/>Dado que existen exposiciones de CO₂ y de ruido en el área,<br/>Cuando el supervisor filtra por alertType igual a co2_exposure,<br/>Entonces el sistema retorna únicamente las exposiciones de CO₂ del historial corto.<br/><br/><strong>Escenario 3: Historial corto vacío</strong><br/>Dado que no existen exposiciones recientes en el área,<br/>Cuando el supervisor ejecuta la consulta,<br/>Entonces el sistema informa que no existen exposiciones recientes registradas.<br/><br/><strong>Escenario 4: Exposición resuelta tras normalización</strong><br/>Dado que una exposición activa finaliza cuando las mediciones retornan al umbral,<br/>Cuando el supervisor consulta el historial corto,<br/>Entonces el sistema muestra la exposición con status igual a resolved y resolvedAt.</td>
      <td align="left">EP04</td>
    </tr>
    <tr>
      <td align="left">HU27</td>
      <td align="left">Detección de exceso de CO₂</td>
      <td align="left">Como supervisor de seguridad quiero que el sistema detecte cuando la concentración de CO₂ supera el límite permitido en un área industrial para activar oportunamente las medidas automáticas de purificación y prevención.</td>
      <td align="left"><strong>Escenario 1: CO₂ dentro del límite permitido</strong><br/>Dado que el sistema monitorea un área industrial con un límite de CO₂ configurado,<br/>Cuando el sensor MQ-135 registra una concentración igual o inferior al límite permitido,<br/>Entonces el sistema mantiene el área en estado ambiental permitido.<br/><br/><strong>Escenario 2: CO₂ por encima del límite permitido</strong><br/>Dado que el sistema monitorea un área industrial con un límite de CO₂ configurado,<br/>Cuando el sensor MQ-135 registra una concentración superior al límite permitido,<br/>Entonces el sistema identifica una condición de CO₂ excesivo y genera una alerta ambiental visible en la aplicación móvil del supervisor.<br/><br/><strong>Escenario 3: Medición de CO₂ inválida descartada</strong><br/>Dado que el sistema recibe una medición de CO₂ desde el dispositivo embebido,<br/>Cuando la medición se encuentra fuera del rango válido del sensor MQ-135,<br/>Entonces el sistema descarta la medición y registra el evento como medición inválida de CO₂.</td>
      <td align="left">EP05</td>
    </tr>
    <tr>
      <td align="left">HU28</td>
      <td align="left">Detección de ruido excesivo</td>
      <td align="left">Como supervisor de seguridad quiero que el sistema detecte cuando el nivel sonoro supera el límite permitido en un área industrial para prevenir la exposición de los operarios a niveles de ruido peligrosos.</td>
      <td align="left"><strong>Escenario 1: Ruido dentro del límite permitido</strong><br/>Dado que el sistema monitorea un área industrial con un límite sonoro configurado,<br/>Cuando el decibelímetro registra un nivel igual o inferior al límite permitido,<br/>Entonces el sistema mantiene el área en estado sonoro permitido.<br/><br/><strong>Escenario 2: Ruido excesivo sin personal presente</strong><br/>Dado que el sistema detecta un nivel sonoro superior al límite permitido<br/>Y el sistema registra ausencia de personal en el área,<br/>Cuando el sistema evalúa la condición ambiental,<br/>Entonces el sistema registra la exposición sonora sin activar la sirena preventiva dirigida a operarios.<br/><br/><strong>Escenario 3: Ruido excesivo con personal presente</strong><br/>Dado que el sistema detecta un nivel sonoro superior al límite permitido<br/>Y el sistema detecta personal presente en el área,<br/>Cuando el sistema evalúa la condición ambiental,<br/>Entonces el sistema genera una alerta de exposición sonora visible en la aplicación móvil del supervisor y activa la sirena preventiva.</td>
      <td align="left">EP05</td>
    </tr>
    <tr>
      ...
      <td align="left"><strong>Escenario 1: Activación del extractor por exceso de CO₂</strong><br/>Dado que un área industrial presenta una concentración de CO₂ superior al límite permitido,<br/>Cuando el sistema confirma la condición de exceso de CO₂,<br/>Entonces el sistema activa el extractor de aire asociado al área mediante el relé de control.<br/><br/><strong>Escenario 2: Desactivación del extractor al normalizar CO₂</strong><br/>Dado que el extractor de aire se encuentra activo por una condición de CO₂ excesivo,<br/>Cuando la concentración de CO₂ retorna al rango permitido,<br/>Entonces el sistema desactiva el extractor de aire del área.<br/><br/><strong>Escenario 3: Fallo en la activación del extractor</strong><br/>Dado que el sistema determina que debe activar el extractor de aire,<br/>Cuando el relé de control no confirma la activación del extractor,<br/>Entonces el sistema registra el fallo y genera una alerta de actuador no disponible visible en la aplicación móvil del supervisor.<br/><br/><strong>Escenario 4: Pérdida de comunicación con el dispositivo embebido durante activación</strong><br/>Dado que el sistema envía la orden de activación al extractor de aire,<br/>Cuando el dispositivo embebido ESP32 no responde dentro del tiempo esperado,<br/>Entonces el sistema registra el fallo de comunicación y mantiene la alerta de CO₂ excesivo activa en la aplicación móvil del supervisor.</td>
      <td align="left">EP05</td>
    </tr>
    <tr>
      <td align="left">HU30</td>
      <td align="left">Activación de sirena preventiva por exposición a condición peligrosa</td>
      <td align="left">Como supervisor de seguridad quiero que el sistema active la sirena preventiva cuando un operario se encuentre expuesto a una condición peligrosa de CO₂ o ruido excesivo para advertir inmediatamente sobre el riesgo existente y permitir la evacuación del área.</td>
      <td align="left"><strong>Escenario 1: Sirena activada por CO₂ peligroso con personal presente</strong><br/>Dado que el sistema detecta una concentración peligrosa de CO₂ en un área industrial<br/>Y el sistema detecta personal presente en el área,<br/>Cuando el sistema determina que existe exposición de operarios,<br/>Entonces el sistema activa la sirena preventiva del área.<br/><br/><strong>Escenario 2: Sirena activada por ruido peligroso con personal presente</strong><br/>Dado que el sistema detecta un nivel de ruido superior al límite permitido<br/>Y el sistema detecta personal presente en el área,<br/>Cuando el sistema determina que existe exposición de operarios,<br/>Entonces el sistema activa la sirena preventiva del área.<br/><br/><strong>Escenario 3: Sirena inactiva en condiciones seguras con personal presente</strong><br/>Dado que el sistema detecta personal presente en un área industrial,<br/>Cuando las concentraciones de CO₂ y los niveles de ruido se encuentran dentro de los límites permitidos,<br/>Entonces el sistema mantiene la sirena preventiva desactivada.<br/><br/><strong>Escenario 4: Desactivación de sirena al cesar condición de riesgo</strong><br/>Dado que la sirena preventiva se encuentra activa por una condición de exposición,<br/>Cuando la condición peligrosa desaparece y no existe otra condición de alarma activa en el área,<br/>Entonces el sistema desactiva la sirena preventiva del área.</td>
      <td align="left">EP05</td>
    </tr>
    <tr>
      <td align="left">HU31</td>
      <td align="left">Despliegue de mamparas acústicas por exposición sonora</td>
      <td align="left">Como supervisor de seguridad quiero que el sistema despliegue mamparas móviles de aislamiento acústico mediante servomotores cuando se detecte ruido excesivo con personal presente para reducir la exposición sonora de los operarios en el área afectada.</td>
      <td align="left"><strong>Escenario 1: Despliegue de mamparas por ruido excesivo con personal</strong><br/>Dado que un área industrial presenta un nivel de ruido superior al límite permitido<br/>Y el sistema detecta personal presente en el área,<br/>Cuando el sistema confirma la condición de exposición sonora,<br/>Entonces el sistema activa los servomotores y despliega las mamparas acústicas del área.<br/><br/><strong>Escenario 2: Retracción de mamparas al normalizar el ruido</strong><br/>Dado que las mamparas acústicas se encuentran desplegadas por una condición de ruido excesivo,<br/>Cuando el nivel sonoro retorna al rango permitido,<br/>Entonces el sistema retrae las mamparas acústicas del área.<br/><br/><strong>Escenario 3: Fallo en el despliegue de mamparas acústicas</strong><br/>Dado que el sistema determina que debe desplegar las mamparas acústicas,<br/>Cuando el servomotor no confirma el despliegue dentro del tiempo esperado,<br/>Entonces el sistema registra el fallo y genera una alerta de actuador no disponible visible en la aplicación móvil del supervisor.</td>
      <td align="left">EP05</td>
    </tr>
    <tr>
      ...
      <td align="left"><strong>Escenario 1: Anulación manual remota de extractor en emergencia</strong><br/>Dado que el extractor de aire de un área se encuentra activo automáticamente<br/>Y el supervisor de seguridad mantiene una sesión activa en la aplicación móvil,<br/>Cuando el supervisor solicita la anulación manual y activación forzada del extractor desde la aplicación móvil,<br/>Entonces el sistema aplica el estado solicitado al extractor y registra la anulación manual con el identificador del supervisor y la fecha del evento.<br/><br/><strong>Escenario 2: Anulación manual remota de sirena en emergencia</strong><br/>Dado que la sirena preventiva de un área se encuentra activa automáticamente<br/>Y el supervisor de seguridad mantiene una sesión activa en la aplicación móvil,<br/>Cuando el supervisor solicita la desactivación manual de la sirena desde la aplicación móvil,<br/>Entonces el sistema desactiva la sirena y registra la anulación manual con el identificador del supervisor y la fecha del evento.<br/><br/><strong>Escenario 3: Anulación manual denegada sin rol de supervisor en la aplicación móvil</strong><br/>Dado que un usuario autenticado en la aplicación web o sin rol de supervisor de seguridad intenta anular un actuador,<br/>Cuando el usuario solicita la anulación manual de un actuador,<br/>Entonces el sistema rechaza la operación e informa que la anulación manual remota requiere el rol de supervisor de seguridad en la aplicación móvil.</td>
      <td align="left">EP05</td>
    </tr>
    <tr>
      <td align="left">HU33</td>
      <td align="left">Registro corto de acciones automáticas ejecutadas</td>
      <td align="left">Como supervisor de seguridad quiero consultar el registro corto de acciones automáticas recientes desde la aplicación móvil para verificar que los mecanismos de prevención respondieron ante las condiciones peligrosas detectadas.</td>
      <td align="left"><strong>Escenario 1: Registro de activación automática de actuador</strong><br/>Dado que el sistema activa un extractor, una sirena o una mampara acústica,<br/>Cuando la acción automática se ejecuta en el área,<br/>Entonces el sistema registra el actuador, la acción realizada, el área y el momento de ejecución.<br/><br/><strong>Escenario 2: Registro de desactivación automática de actuador</strong><br/>Dado que un actuador se encuentra activo por una condición ambiental,<br/>Cuando el sistema determina que la condición que originó la acción ha finalizado,<br/>Entonces el sistema registra la desactivación del actuador con el área y el momento del evento.<br/><br/><strong>Escenario 3: Consulta del registro corto desde la aplicación móvil</strong><br/>Dado que existen acciones automáticas recientes en un área,<br/>Cuando el supervisor consulta el registro corto desde la aplicación móvil,<br/>Entonces el sistema presenta las acciones recientes con actuador, área, resultado y momento de ejecución.<br/><br/><strong>Escenario 4: Registro de acción automática fallida</strong><br/>Dado que el sistema envía una orden automática a un actuador,<br/>Cuando el actuador no confirma la ejecución,<br/>Entonces el sistema registra la acción como fallida con el actuador, el área y el motivo del fallo.</td>
      <td align="left">EP05</td>
    </tr>
    <tr>
      <td align="left">HU34</td>
      <td align="left">Notificación física de alarma al operario expuesto</td>
      <td align="left">Como operario de planta quiero recibir una alarma física audible cuando me encuentre expuesto a una condición peligrosa de CO₂ o ruido excesivo para conocer la situación de riesgo y retirarme de el área afectada.</td>
      <td align="left"><strong>Escenario 1: Alarma audible por exposición a CO₂ peligroso</strong><br/>Dado que el operario se encuentra en un área industrial con condición peligrosa de CO₂,<br/>Cuando el sistema activa la sirena preventiva del área,<br/>Entonces el operario recibe la señal audible de alarma en el entorno físico del área.<br/><br/><strong>Escenario 2: Alarma audible por exposición a ruido excesivo</strong><br/>Dado que el operario se encuentra en un área industrial con nivel de ruido superior al límite permitido,<br/>Cuando el sistema activa la sirena preventiva del área,<br/>Entonces el operario recibe la señal audible de alarma en el entorno físico del área.<br/><br/><strong>Escenario 3: Ausencia de alarma en condiciones seguras</strong><br/>Dado que el operario se encuentra en un área industrial,<br/>Cuando las condiciones de CO₂ y ruido se encuentran dentro de los límites permitidos,<br/>Entonces el sistema mantiene la sirena preventiva desactivada en el área.<br/><br/><strong>Escenario 4: Fallo de sirena con operario expuesto</strong><br/>Dado que el operario se encuentra en un área con condición de riesgo activa,<br/>Cuando el buzzer de la sirena no responde a la orden de activación,<br/>Entonces el sistema registra el fallo del actuador y mantiene la alerta de exposición activa en la aplicación móvil del supervisor de seguridad.</td>
      <td align="left">EP05</td>
    </tr>
    <tr>
      <td align="left">HU35</td>
      <td align="left">Actualización de parámetros de configuración del sistema</td>
      <td align="left">Como supervisor de seguridad quiero aplicar actualizaciones de parámetros de configuración del sistema desde la aplicación móvil para mantener áreas, umbrales, dispositivos y reglas alineados con la operación de seguridad de la planta.</td>
      <td align="left"><strong>Escenario 1: Actualización exitosa de parámetros de configuración</strong><br/>Dado que el supervisor de seguridad mantiene una sesión activa en la aplicación móvil<br/>Y existen parámetros de configuración válidos para áreas, umbrales o dispositivos,<br/>Cuando el supervisor confirma la actualización de los parámetros del sistema,<br/>Entonces el sistema almacena la nueva configuración y la deja disponible para el monitoreo y control operativo.<br/><br/><strong>Escenario 2: Actualización con parámetros incompletos o inválidos</strong><br/>Dado que el supervisor de seguridad intenta actualizar la configuración del sistema en la aplicación móvil,<br/>Cuando uno o más parámetros obligatorios están incompletos o no cumplen las restricciones del sistema,<br/>Entonces el sistema rechaza la actualización e informa los parámetros que deben corregirse.<br/><br/><strong>Escenario 3: Consulta de versión o estado de configuración aplicada</strong><br/>Dado que el supervisor accede a la sección de actualizaciones en la aplicación móvil,<br/>Cuando el supervisor consulta el estado de la configuración del sistema,<br/>Entonces el sistema presenta la configuración vigente y la fecha de la última actualización aplicada.<br/><br/><strong>Escenario 4: Intento de actualización técnica por encargado de planta</strong><br/>Dado que un encargado de planta autenticado en la aplicación web intenta aplicar una actualización técnica de parámetros del sistema,<br/>Cuando solicita la actualización,<br/>Entonces el sistema deniega la operación e informa que la configuración técnica corresponde al supervisor en la aplicación móvil.</td>
      <td align="left">EP05</td>
    </tr>
    <tr>
      <td align="left">HU36</td>
      <td align="left">Compatibilidad de la aplicación móvil y de la aplicación web</td>
      <td align="left">Como supervisor de seguridad quiero usar la aplicación móvil en dispositivos Android e iOS actuales para operar y configurar técnicamente el sistema de seguridad, y como encargado de planta quiero usar la aplicación web en navegadores modernos para gobernar usuarios y consultar métricas e historial.</td>
      <td align="left"><strong>Escenario 1: Operación desde aplicación móvil en dispositivo compatible</strong><br/>Dado que un supervisor de seguridad accede a la aplicación móvil en un dispositivo Android o iOS soportado,<br/>Cuando el supervisor consulta el dashboard operativo y el detalle de un área industrial,<br/>Entonces el sistema presenta valores de CO₂ en ppm, ruido en dB, presencia y alertas activas de forma legible y operable en el dispositivo utilizado.<br/><br/><strong>Escenario 2: Gobernanza desde aplicación web en navegador compatible</strong><br/>Dado que un encargado de planta accede a la aplicación web desde un navegador web moderno soportado,<br/>Cuando el encargado consulta la administración de usuarios o el dashboard de métricas,<br/>Entonces el sistema presenta las funciones de gobernanza de forma legible y operable en el navegador utilizado.<br/><br/><strong>Escenario 3: Acceso desde navegador o dispositivo no soportado</strong><br/>Dado que un usuario intenta acceder a la aplicación web o a la aplicación móvil desde un entorno no incluido en la matriz de compatibilidad soportada,<br/>Cuando el usuario solicita acceso a funciones protegidas,<br/>Entonces el sistema informa que el entorno utilizado no se encuentra soportado<br/>Y el sistema indica los entornos compatibles correspondientes a cada canal.<br/><br/><strong>Escenario 4: Configuración técnica de dispositivos en dispositivo móvil compatible</strong><br/>Dado que un supervisor de seguridad accede a la aplicación móvil desde un dispositivo soportado,<br/>Cuando el supervisor registra un sensor o actuador en un área,<br/>Entonces el sistema permite completar el registro de forma operable en el dispositivo utilizado.<br/><br/><strong>Escenario 5: Separación funcional entre canales compatibles</strong><br/>Dado que un supervisor de seguridad opera, configura dispositivos y actualiza parámetros desde la aplicación móvil y un encargado de planta administra usuarios y consulta métricas desde la aplicación web,<br/>Cuando ambos usuarios realizan sus funciones autorizadas durante la misma jornada,<br/>Entonces el sistema mantiene coherente la telemetría y las alertas en la aplicación móvil<br/>Y refleja en el dashboard web la información consolidada sin mezclar las responsabilidades de cada canal.</td>
      <td align="left">EP06</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left">API Endpoint de consulta de telemetría por área</td>
      <td align="left">Como Developer quiero exponer un endpoint REST de consulta de telemetría reciente por área para alimentar el monitoreo operativo de la aplicación móvil.</td>
      <td align="left"><strong>Escenario 1: Consulta exitosa de telemetría reciente</strong><br/>Dado que existen mediciones persistidas para areaId Z1<br/>Y un cliente presenta un JWT de supervisor vigente,<br/>Cuando el cliente solicita GET /api/v1/areas/Z1/telemetry/latest,<br/>Entonces la API responde 200 OK con areaId, co2Ppm, noiseDb, presenceDetected, measuredAt y quality.<br/><br/><strong>Escenario 2: Consulta de historial por rango temporal</strong><br/>Dado que existen mediciones en el rango solicitado,<br/>Cuando el cliente solicita GET /api/v1/areas/Z1/telemetry?from=...&to=...,<br/>Entonces la API responde 200 OK con items[], nextCursor opcional y count.<br/><br/><strong>Escenario 3: Área inexistente</strong><br/>Dado que el cliente solicita telemetría de una areaId no registrada,<br/>Cuando la API buscal área,<br/>Entonces la API responde 404 Not Found con code igual a area_not_found.<br/><br/><strong>Escenario 4: Token de supervisor ausente o inválido</strong><br/>Dado que el cliente omite Authorization o envía un JWT inválido,<br/>Cuando la API evalúa autenticación,<br/>Entonces la API responde 401 Unauthorized con code igual a unauthorized.<br/><br/><strong>Escenario 5: Error interno de lectura en base de datos</strong><br/>Dado que la consulta es válida<br/>Y la base de datos produce un error inesperado,<br/>Cuando la API maneja la excepción,<br/>Entonces la API responde 500 Internal Server Error con code igual a internal_error y correlationId.<br/><br/><strong>Escenario 6: Timeout del cliente ante latencia elevada</strong><br/>Dado que el cliente móvil inicia la consulta<br/>Y la latencia supera el timeout del cliente,<br/>Cuando el cliente aborta la solicitud,<br/>Entonces el cliente registra timeout sin asumir datos actualizados<br/>Y puede reintentar GET /api/v1/areas/Z1/telemetry/latest.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left">Como Developer quiero persistir alertas y acciones de actuadores en la base de datos relacional cloud para habilitar historial operativo consultable por la aplicación móvil y el historial completo por la aplicación web.</td>
      <td align="left"><strong>Escenario 1: Persistencia exitosa de alerta</strong><br/>Dado que el Gateway envía POST /api/v1/alerts con areaId, alertType, measuredValue y detectedAt,<br/>Cuando la API valida y almacena la alerta,<br/>Entonces la API responde 201 Created con alertId y status igual a active.<br/><br/><strong>Escenario 2: Persistencia exitosa de acción de actuador</strong><br/>Dado que el Gateway envía POST /api/v1/actuator-events con actuatorType, action, result y executedAt,<br/>Cuando la API almacena el evento,<br/>Entonces la API responde 201 Created con eventId.<br/><br/><strong>Escenario 3: Rechazo por alerta con área inexistente</strong><br/>Dado que alert.areaId no existe en el catálogo,<br/>Cuando la API valida integridad referencial,<br/>Entonces la API responde 404 Not Found o 422 Unprocessable Entity con code igual a area_not_found.<br/><br/><strong>Escenario 4: Rechazo por payload de acción incompleto</strong><br/>Dado que falta actuatorType en el cuerpo,<br/>Cuando la API valida el esquema,<br/>Entonces la API responde 400 Bad Request con field igual a actuatorType.<br/><br/><strong>Escenario 5: Error 500 al persistir alerta</strong><br/>Dado que la base de datos falla durante el INSERT,<br/>Cuando la API captura el error,<br/>Entonces la API responde 500 Internal Server Error con correlationId.<br/><br/><strong>Escenario 6: Consulta de historial de alertas</strong><br/>Dado que existen alertas persistidas para un área,<br/>Cuando un supervisor autenticado solicita GET /api/v1/areas/Z1/alerts,<br/>Entonces la API responde 200 OK con items[] que incluyen alertId, alertType, status y detectedAt.</td>
      <td align="left">EP05</td>
    </tr>
    <tr>
      <td align="left">TS21</td>
      <td align="left">API Endpoint de autenticación de usuarios de app móvil y web</td>
      <td align="left">Como Developer quiero exponer un endpoint de autenticación de usuarios que emita JWT de supervisor o encargado para proteger los recursos de operación/configuración técnica móvil y de gobernanza web.</td>
    ...
    <tr>
      ...
      <td align="left">API CRUD de áreas industriales y umbrales ambientales</td>
      <td align="left">Como Developer quiero exponer endpoints REST de creación, lectura, actualización y baja lógica de áreas industriales y umbrales para que la aplicación móvil del supervisor persista el modelo operativo por sectores de la planta.</td>
      <td align="left"><strong>Escenario 1: Creación exitosa de área industrial</strong><br/>Dado que un JWT de supervisor vigente envía POST /api/v1/areas con name, locationDescription y machineReferences,<br/>Cuando la API valida y persiste el área,<br/>Entonces la API responde 201 Created con areaId, name y status igual a active.<br/><br/><strong>Escenario 2: Actualización de umbrales de área</strong><br/>Dado que existen umbrales para areaId A1,<br/>Cuando el cliente envía PUT /api/v1/areas/A1/thresholds con co2ThresholdPpm y noiseThresholdDb,<br/>Entonces la API responde 200 OK con configVersion incrementada y updatedAt.<br/><br/><strong>Escenario 3: Rechazo por nombre de área duplicado</strong><br/>Dado que ya existe un área con el mismo name,<br/>Cuando el cliente solicita POST /api/v1/areas,<br/>Entonces la API responde 409 Conflict con code igual a area_name_duplicate.<br/><br/><strong>Escenario 4: Rechazo por umbral fuera de rango</strong><br/>Dado que noiseThresholdDb es negativo o supera el máximo permitido,<br/>Cuando la API valida dominio,<br/>Entonces la API responde 422 Unprocessable Entity con field igual a noiseThresholdDb.<br/><br/><strong>Escenario 5: Baja lógica de área</strong><br/>Dado que el supervisor solicita DELETE /api/v1/areas/A1,<br/>Cuando la API marca el área como inactive,<br/>Entonces la API responde 200 OK con status igual a inactive.<br/><br/><strong>Escenario 6: Error de persistencia en base de datos</strong><br/>Dado que la base de datos falla durante INSERT de área,<br/>Cuando la API captura la excepción,<br/>Entonces la API responde 500 Internal Server Error con correlationId.</td>
      <td align="left">EP03</td>
    </tr>
    <tr>
...
Identity & Access resuelve quién entra a SafePlant, con qué rol y por qué canal —app móvil del supervisor o cliente web del encargado de planta—, y la recuperación de credenciales. Es un **Generic Subdomain** (DEC-001): no mide la planta ni evalúa exposición, solo concede o niega la sesión que Plant Monitoring y Safety & Actuation exigen vía Open Host Service. Vive enteramente en el monolito cloud (`Web Monolithic Backend`); el Edge no administra usuarios, solo autentica dispositivos (Device & Edge Management).
...
Identity & Access vive dentro del único container `Web Monolithic Backend` (DEC-005). Sus cuatro capas se modelan como `component` hexagonales anidados en ese container, en la vista `IdentityAccessComponents` de [`docs/diagrams/c4.dsl`](../diagrams/c4.dsl): Interface recibe las llamadas de las apps, Application orquesta comandos y queries, Domain concentra los aggregates y `AccessPolicy`, e Infrastructure implementa los repositorios y habla con `Cloud Database` y `Email Service`.
...
Fuente: [`docs/diagrams/bounded-contexts/bc-04-identity-domain.puml`](../diagrams/bounded-contexts/bc-04-identity-domain.puml). Incluye los tres aggregates, sus value objects, el domain service `AccessPolicy`, el puerto `IEmailSender` y las interfaces de repositorio, con scope, multiplicidad y dirección de cada relación.
...
Fuente: [`docs/diagrams/bounded-contexts/bc-04-identity-database.puml`](../diagrams/bounded-contexts/bc-04-identity-database.puml). Modelo relacional lógico (motor `TBD`): `user_accounts`, `sessions` y `credential_recoveries`, con `email` y los hashes de token como `UNIQUE`, y llaves foráneas de `sessions`/`credential_recoveries` hacia `user_accounts`.
