...
| --- | --- | --- |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | **Baldeon Vivar, Santiago Armando**<br>AV1: Lideró la sesión de Design-Level EventStorming (sección 4.1.1), guiando al equipo en la identificación de comandos y políticas del dominio de monitoreo IoT, asegurando que todos los integrantes aportaran desde sus roles.<br><br>**Gordillo Ramos, Santiago Alonso**<br>AV1: Asumió el liderazgo en la investigación de usuarios (secciones 2.2 y 2.3), moderando las entrevistas con los supervisores de seguridad y consolidando los hallazgos para definir los User Personas del proyecto.<br><br>**Huamán Cuba, Johan Giovani**<br>AV1: Dirigió la definición de la Arquitectura de Software (sección 4.1.3), estructurando los diagramas C4 y coordinando con el equipo la separación por capas aplicando Domain-Driven Design y Clean Architecture.<br><br>**Iglesias Pérez, Sergio Sebastián**<br>AV1: Lideró la estrategia de despliegue y control de versiones (sección 6.1), capacitando al equipo en el uso de GitFlow y Conventional Commits para mantener un repositorio ordenado y libre de conflictos.<br><br>**Sanchez Gonzales, Ariana Mia**<br>AV1: Tomó la iniciativa en el diseño UX/UI (Capítulo V), estableciendo el Design System y las guías de estilo, y dirigiendo las sesiones de wireframing en Figma para la aplicación móvil y web.<br><br>**Solano Armas, Angelo Hector**<br>AV1: Coordinó la redacción y estandarización del Ubiquitous Language (sección 2.5), asegurando que los términos del sector industrial (CO2, mitigadores, umbrales) se usaran de forma consistente en toda la documentación. | El equipo concluye que distribuir el liderazgo por áreas de especialidad (arquitectura, UX, requerimientos, DevOps) permitió que cada integrante dirigiera de forma autónoma una parte crítica del proyecto, fomentando el empoderamiento y asegurando decisiones técnicas mejor fundamentadas durante la primera entrega (AV1). |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos. | **Baldeon Vivar, Santiago Armando**<br>AV1: Estableció los objetivos del Sprint 1 (Sprint Goal) y participó activamente en el Sprint Planning (sección 6.2.1), asegurando que la carga de trabajo fuera equitativa entre los desarrolladores.<br><br>**Gordillo Ramos, Santiago Alonso**<br>AV1: Planificó las tareas de Needfinding y distribuyó la redacción de los User Journeys y Empathy Maps para asegurar la participación de todos los miembros en el análisis UX.<br><br>**Huamán Cuba, Johan Giovani**<br>AV1: Facilitó un entorno colaborativo documentando los estándares de código y configurando el ambiente de desarrollo para que el equipo pudiera trabajar con Spring Boot, Angular y Python sin bloqueos técnicos.<br><br>**Iglesias Pérez, Sergio Sebastián**<br>AV1: Gestionó el Product Backlog y el Sprint Backlog (sección 3.3), guiando las estimaciones de Story Points mediante Planning Poker e integrando el feedback de todo el equipo de manera inclusiva.<br><br>**Sanchez Gonzales, Ariana Mia**<br>AV1: Promovió la inclusión organizando reuniones de revisión de interfaz donde todos los integrantes, independientemente de su perfil técnico, evaluaron la usabilidad de los mockups antes de su aprobación.<br><br>**Solano Armas, Angelo Hector**<br>AV1: Supervisó el cumplimiento de las metas documentando las evidencias de colaboración en GitHub (Project Report Collaboration Insights) y verificando que todos los Pull Requests tuvieran al menos un revisor asignado. | El equipo concluye que el uso documentado y riguroso de repositorios compartidos y herramientas ágiles impuso una disciplina colaborativa esencial. Trabajar de manera iterativa permitió establecer metas claras, visibilizar el progreso de cada tarea y garantizar que todos los miembros cumplieran sus objetivos en un ambiente de apoyo mutuo. |
